...
import { Path, Circle, Line } from '@shopify/react-native-skia'
...
export const WinkEyes = ({ withLashes }: EyeProps) => {
  ...
  return (
    <>
      ...
      />
      <Path
        path="M627,574.16a114.14,114.14,0,0,1,13.07-1.56c4.36-.3,8.72-.43,13.08-.44s8.71.14,13.07.43a114.34,114.34,0,0,1,13.08,1.57,112.18,112.18,0,0,1-13.08,1.58q-6.54.43-13.07.42t-13.08-.43A112,112,0,0,1,627,574.16Z"
